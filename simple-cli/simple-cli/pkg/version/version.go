...
//
//	-X github.com/your-org/simple-cli/pkg/version.Version=$(git describe --tags)
//	-X github.com/your-org/simple-cli/pkg/version.Commit=$(git rev-parse --short HEAD)
//	-X github.com/your-org/simple-cli/pkg/version.BuildDate=$(date -u +%Y-%m-%dT%H:%M:%SZ)
package version
